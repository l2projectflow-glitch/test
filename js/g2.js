$(document).ready(function(){
	...
	$("body").on('click', '.captcha a', function() {
		$('.captchaImage').attr('src', './ucp/captcha/securimage_show.php?sid='+Math.random()+'');
...
function atualAlert(texto, act, url) {
	...
	$('#alerta').css({ 'left': ''+(($(window).width()-($('#alerta').width()+60))/2)+'px', 'top': ''+'10px', 'visibility': 'visible' });
}
