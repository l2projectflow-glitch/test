	...
	<form method='POST' action='./?module=configs&engine=changedata' class='usarJquery'>
		...
		<label class='formpadrao'>
			<div>
				...
				<div class='camp'><input type='text' disabled value='<?php echo (!empty($accData[0]['login']) ? $accData[0]['login'] : ''); ?>' /></div>
			</div>
		</label>
	...
	<form method='POST' action='./?module=configs&engine=emailchange' class='usarJquery'>
		...
		<label class='formpadrao'>
			<div>
				...
				<div class='camp'><input type='text' disabled value='<?php echo (!empty($accData[0]['email']) ? $accData[0]['email'] : ''); ?>' /></div>
			</div>
		</label>
