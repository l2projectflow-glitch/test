...
if(count($donation) > 0) {
	...
	if($donation[0]['status'] == 1) {
		...
		switch(strtolower($metodo_pgto)) {
			...
			case 'banking':
			 $link_address = 'https://wa.me/5544988426516';
				echo "
				<h1>".$LANG[10040]."</h1>
				<div class='pddInner'>
					".$LANG[15005].":<br /><br />
					".$Banking['bank_dados']."
					<br /><br />
					<div class='rmsg warn'>".$LANG[15004].": <b><a href=".$link_address.">https://wa.me/5544988426516</a></b></div>
				</div>
				";
					...
					<div id=\"checkoutForm\">
						...
						<div id=\"checkoutForm\">
							<script src=\"https://checkout.pay.g2a.com/index/checkout\"
								...
								data-items[0][qty]=\"".trim($donation[0]['quant_coins'])."\"
								data-items[0][price]=\"".(trim($donation[0]['quant_coins'])/trim($donation[0]['valor']))."\"
