...
<section class="content">
	...
	<div class="box">
		...
		<div class="box-body">
			...
			Você tem certeza que deseja excluir a doação de protocolo <b><?php echo $consulta[0]['protocolo']; ?></b>?<br /><br />
			...
			<div style='display: table; margin: 20px auto;'>
				...
				&nbsp;
				<a class='btn btn-danger usarJquery' href='?engine=delete&module=donate&protocolo=<?php echo $consulta[0]['protocolo']; ?>'>Excluir</a>
			</div>
