...
if(isset($siteVinculed)) { $dir_gallery = '../'.$dir_gallery; }
...
if($cookieLang == 'pt' || $cookieLang == 'en' || $cookieLang == 'es') {
	...
	$nativeLang = !empty($_SERVER["HTTP_ACCEPT_LANGUAGE"]) ? trim($_SERVER["HTTP_ACCEPT_LANGUAGE"]) : ''; $nativeLang = (strlen($nativeLang) > 1) ? strtolower(substr($nativeLang, 0, 2)) : '';
	if(!empty($nativeLang)) {
